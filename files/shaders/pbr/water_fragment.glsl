...
const float SCATTER_AMOUNT = 4.0;                  // amount of sunlight scattering
...
void main(void)
{
    ...
    vec2 screenCoordsref = screenCoords;
    ...
    float sunFade = length(lcalcDiffuse(0).xyz + 0.33 * gl_LightModel.ambient.xyz);
   ...
   vec3 debcolmix = gl_FragData[0].xyz;
